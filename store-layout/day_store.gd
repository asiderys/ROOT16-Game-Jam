...
var orb = preload("res://store-layout/orb.tres")

var npcTyepes = [ 
	preload("res://store-layout/orb_yellow.tres"), 
	preload("res://store-layout/orb_pink.tres"), 
	preload("res://store-layout/orb_green.tres"), 
	preload("res://store-layout/orb_blue.tres") 
]
